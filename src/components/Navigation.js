            ...
            <Navbar bg="dark" variant="dark">
                ...
                <Nav className="mr-auto">
                    ...
                    <NavDropdown title="Exercise Menu" id="basic-nav-dropdown">
                        <NavDropdown.Item href="lunge.html">Lunge</NavDropdown.Item>
                        <NavDropdown.Item href="#action/2.2">Push Up</NavDropdown.Item>
                        <NavDropdown.Item href="#action/2.3">Squat</NavDropdown.Item>
